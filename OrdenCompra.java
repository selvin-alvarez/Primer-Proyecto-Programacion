...
class OrdenCompra {
    ...
    public static Producto ingresarDatosProducto(Scanner entrada, String nombreProducto) {
        ...
        Producto producto = new Producto(nombreProducto, 0.0, "", cantidad) {
            @Override
    ...
    public void guardarDatosEnArchivo(Producto... productos) {
        try (FileWriter writer = new FileWriter("OrdenCompra.txt")) {
            writer.write("Número de Orden: " + numeroOrden + "\n");
            writer.write("Nombre del Proveedor: " + nombreProveedor + "\n");
            writer.write("Dirección del Proveedor: " + direccionProveedor + "\n");
            writer.write("NIT del Proveedor: " + nitProveedor + "\n");
